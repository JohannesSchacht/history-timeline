import { DatePrecision, HistoricalDate, HistoricalEvent } from './model';
 ...
 */
export function formatHistoricalDate(date: HistoricalDate, precision: DatePrecision): string {
...
export function formatEventDate(event: HistoricalEvent): string {
